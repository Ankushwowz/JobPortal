               ...
               <div class="col-lg-12">
                  ...
                  <div class="form-content-box">
                     ...
                     <div class="details">
                        ...
                        <!-- Form start-->
                        <form action="<?php echo base_url();?>signup" method="POST" role="form" novalidate="" id="signup_form">
                           <div class="form-group">
                              <select name="role" class="input-text" required="true">
                                 <option value="">Select Role</option>
                                 <option value="1" <?php if($this->input->post('role')==1){ echo"selected";}?> >Candidate</option>
                                 <option value="2" <?php if($this->input->post('role')==2){ echo"selected";}?>>Employer</option>
                              </select>
                           </div>
                           <div class="form-group">
                              <input type="text" name="fullname" class="input-text" placeholder="Full Name" required="true" value="<?php
                                 if($this->input->post('fullname')){ echo $this->input->post('fullname');}?>">
                           </div>
                           <div class="form-group">
                              <input id="email" type="email" name="email" class="input-text" placeholder="Email Address" required="true" value="<?php
                                 if($this->input->post('email')){ echo $this->input->post('email');}?>">
                              <span style="display: none;" class="error_bt email-error" id="email-error">Please enter a vaild email</span>
                              <?php if(!empty(form_error('email'))) {?>
                              <span class="error_bt email-error" id="email-error"><?php echo form_error('email');?></span>
                              <?php } ?>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              <input type="password" name="confirm_Password" class="input-text" placeholder="Confirm Password" required="true" id="confirm_Password">
                              <span style="display: none;" class="error_bt" id="passC-error">password and confirm password does not match</span>
                           </div>
                           <div class="form-group mb-0">
                              <input  type="submit" class="btn-md button-theme btn-block" value="Signup" name="Signup">
                           </div>
                        </form>
                        <!-- Social List -->
