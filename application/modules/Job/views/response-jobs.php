                        ...
                        <div class="dashboard-list">
                            <div class="job-info job-info-2">
                                <table class="table" id="myTable">
                                    ...
                                    <tr class="responsive-table" id="job-<?php echo $ResponseJobs['job_id'];?>">
                                      
                                        <td class="p-left-20">
                                            <div class="inner">
                                                <h5><a href="<?php echo base_url();?>view-response-job/<?php echo base64_encode($ResponseJobs['jobID']);?>"><?php echo $ResponseJobs['job_title']?></a></h5>
