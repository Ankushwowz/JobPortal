                ...
                <div class="content-area5 dashboard-content">
					...
					<?php if($this->session->flashdata('success')){  
                      ...
                      <form  enctype="multipart/form-data" action="<?php echo base_url();?>edit-job/<?php echo $this->uri->segment(2);?>" method="POST" role="form" novalidate="" id="job_post_form">
                            <h4 class="bg-grea-3">Edit Job</h4>
                            <div class="search-contents-sidebar">
                                <div class="row pad-20">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label>Job Title</label>
                                            <input type="text" class="input-text" name="job_title" placeholder="Your Title"  required="true" value="<?php echo $Jobs['job_title']?>" maxlength="250">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
									...
									<progress id="progressBar" value="0" max="100" style="width:300px;"></progress>
									 ...
									 <div class="col-lg-12">
									 <input  type="submit" class="btn btn-md button-theme" name="postJob" value="Edit job">
									 </div>
