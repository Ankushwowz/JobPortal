                        ...
                        <div class='form-row row'>
                         ...
                         <div class='form-row row'>
                            <div class='col-xs-12 form-group required'>
                              ...
                              if(!empty($jobamount['job_amount'])) { ?>
                                   <p>$<?php echo $jobamount['job_amount']?></p> 
                               <?php }

                               }else{ 

                                if( !empty($jobamount['job_amount'])  && !empty($commission['commission'])) { 

                            $Percentage =  ($jobamount['job_amount'] * $commission['commission'])/100;

                                }?>
                                    <p> $<?php if( !empty($jobamount['job_amount'])  && !empty($commission['commission'])) { 

                                               echo  $amountTransfer =  $jobamount['job_amount'] - $Percentage;
