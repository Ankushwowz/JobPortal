    ...
    */
    public function stripePost(){
		...
		$amount =$jobDetails['job_amount'];
			...
			$commission = $this->Administrator_model->getCommission();
			$Percentage =  ($jobDetails['job_amount'] * $commission['commission'])/100;
			$amountTransfer =  $jobDetails['job_amount'] - $Percentage;
