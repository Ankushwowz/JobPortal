                ...
                <div class="content-area5">
                    <div class="dashboard-content">
                        <div class="dashboard-header clearfix">
                            <div class="row">
                                <div class="col-sm-12 col-md-6"><h4>Rejected Jobs</h4></div>
                                ...
                                <table class="table" id="myTable">
									...
									<?php } ?>
										...
										<?php if($this->session->userdata('Session_data')['role']==2) {?>
                                          <td><button type="button" class="btn btn-primary resend_Job" rel="<?php echo $JobsList['invite_user_id'];?>" >Resend Job</button></td>
										<?php } ?>
                                    </tr><?php 
									}?>
