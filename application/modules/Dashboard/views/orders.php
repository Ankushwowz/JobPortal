                            ...
                            <div class="job-info job-info-2">
                                <table class="table" id="myTable">
                                    ...
                                    <tr class="responsive-table" id="job-<?php echo $payment['order_id'];?>">
                                        ...
                                        $GetResult =  $this->Dashboard_model->paymentby_admin_to_seller($payment['job_id']);    ?>
