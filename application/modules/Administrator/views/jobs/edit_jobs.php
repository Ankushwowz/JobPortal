<div class="col-lg-9 col-md-12 col-sm-12 col-pad">
                <div class="content-area5 dashboard-content">
					...
					<?php if($this->session->flashdata('success')){  
                        ...
                        <?php } ?>
                      <form  enctype="multipart/form-data" action="<?php echo base_url();?>edit-jobs/<?php echo $this->uri->segment(2);?>" method="POST" role="form" novalidate="" id="job_post_form">
                                ...
                                <div class="row pad-20">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="input-text digits-cls" name="job_amount" placeholder="USD" required="true" value="<?php echo $Jobs['job_amount']?>">
                                        </div>
                                    </div>
