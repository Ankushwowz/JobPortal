                                        ...
                                        <div class="table-responsive dashboard-table-responsive">
                                            ...
                                            <table class="table mb-0" id="myTable">
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if($user['image']!=''){ ?>     
                                                    <td><img src="<?php echo base_url(); ?>assets/img/category/<?php echo $user['image']; ?>" style="width:50px; height:40px;"></td>
                                                    <?php } else { ?>
                                                    <td><img src="<?php echo base_url(); ?>assets/img/No_Image.jpg" style="width:100px; height:70px;"></td>
                                                    <?php } ?>
                                                    ...
                                                    <td> 
                                                    <a rel="<?php echo $user['category_id']; ?>" href="<?php echo base_url(); ?>edit-category/<?php echo $user['category_id']; ?>" class="delete edit-user"><i class="fa fa-edit"></i></a>                                                       
                                                        <a rel="<?php echo $user['category_id']; ?>" href="#" class="delete delete-category"><i class="fa fa-trash"></i></a></td>
                                                </tr>
