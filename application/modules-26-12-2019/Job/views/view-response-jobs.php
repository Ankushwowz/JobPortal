  ...
  <div class="col-lg-9 col-md-12 col-sm-12 col-pad">
                <div class="content-area5 dashboard-content">
                    <div class="dashboard-header clearfix">
                        <div class="row">
                            <div class="col-sm-12 col-md-6"><h4>Job Responses</h4></div>
												 ...
												 <?php   }else{
												   ...
												   if($countJobAssign > 0){
													   ...
													   if(!empty($JobAssignuser) && count($JobAssignuser) > 0){
														   ...
														   <span  class="btn btn-success hover-none ">Assigned Job </span>
														   <?php } else{ ?>  <span  class="btn btn-success hover-none">Completed Job</span><?php }
													  ?>
													...
													<!--<a href="<?php //echo base_url()?>escrow/<?php //echo base64_encode($ResponseJobs['job_id']);?>/<?php //echo base64_encode($ResponseJobs['user_id']);?>">Escrow</a>-->
												</div>
                                            </div>
											<div class="row">
...
<input style="display:none;" type="file" class="upload" name="userJobReplyFile[]" multiple id="userJobReplyFile">
<div class="col-lg-12 replyuplaodimagecls" >
			<div class="photoUpload photoUpload-2">
				Upload Files
				<input type="file" class="upload" name="userfile" id="chatFile" onchange="uploadmessageFile()">
