               ...
               <div class="col-lg-12">
                  ...
                  <div class="form-content-box">
                     ...
                     <div class="details">
                        ...
                        <!-- Form start -->
                        <form action="<?php echo base_url();?>forgot-password" method="POST" role="form" novalidate="" id="login_form">
                           ...
                           <div class="form-group mb-0">
                              <input  type="submit" class="btn-md button-theme btn-block" name="forgot_password" value="Forgot Password">
                           </div>
                        </form>
                        <!-- Social List -->
                     ...
                     <!-- Footer -->
                     <div class="footer">
                        <span>Don't have an account? <a href="<?php echo base_url();?>signup">Register here</a></span>
                     </div>
                  </div>
