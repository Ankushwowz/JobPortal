               ...
               <div class="col-lg-12">
                  ...
                  <div class="form-content-box">
                     ...
                     <div class="details">
                        ...
                        <!-- Form start -->
                        <form action="<?php echo base_url();?>login" method="POST" role="form" novalidate="" id="login_form">
                           ...
                           <div class="checkbox">
                              ...
                              <a href="<?php echo base_url();?>forgot-password" class="link-not-important pull-right">Forgot Password</a>
